...
Application path: /Users/johnson/workspace/rails-apps/checkers_app
Rails version: 4.0.4
Brakeman version: 2.4.3
Started at 2014-05-01 07:33:42 -0400
Duration: 0.772329 seconds
...
| GamesController       | ApplicationController  | ActionController::Live      | destroy, index, join, mytu>>
...
| UsersController       | ApplicationController  |                             | create, edit, index, new, >>
+-----------------------+------------------------+-----------------------------+--------------------------->>
...
| [Escaped Output] image_tag(@pieceImages["-2"], :class => "dojoDndItem")                                  >>
| [Escaped Output] @turn                                                                                   >>
| [Escaped Output] javascript_tag do; [Escaped Output] image_tag(@pieceImages["1"]);[Escaped Output] image_>>
| [Escaped Output] render(partial => "matchtitle", {})                                                     >>
| [Escaped Output] content_tag(:div, "Wait for your turn", :class => "text-center alert alert-warning", :id>>
...
| [Escaped Output] @game.get_turn_color(current_user)                                                      >>
| [Escaped Output] javascript_tag do; [Escaped Output] image_tag("pr.png");[Escaped Output] image_tag("kr.p>>
| [Escaped Output] render(partial => "matchtitle", {})                                                     >>
| [Escaped Output] content_tag(:div, "Wait for your turn", :class => "text-center alert alert-warning", :id>>
| [Escaped Output] ("y" + (local y).to_s)                                                                  >>
| [Escaped Output] ("x" + (local x).to_s)                                                                  >>
| [Escaped Output] image_tag({ "1" => "pr.png", "2" => "kr.png", "-1" => "pw.png", "-2" => "kw.png" }[@game>>
| [Escaped Output] image_tag({ "1" => "pr.png", "2" => "kr.png", "-1" => "pw.png", "-2" => "kw.png" }[@game>>
| [Escaped Output] image_tag({ "1" => "pr.png", "2" => "kr.png", "-1" => "pw.png", "-2" => "kw.png" }[@game>>
+---------------------------------------------------------------------------------------------------------->>
...
| [Escaped Output] link_to("delete", game, :method => :delete, :data => ({ :confirm => "You sure?" }), :cla>>
...
| [Escaped Output] "White: #{@game.white.name}" unless @game.white.nil?    |
| [Escaped Output] "Winner: #{@game.winner.name}" unless @game.winner.nil? |
| [Escaped Output] "Game Moves" if @game.moves.any?                        |
| [Escaped Output] render(action => @game.moves, {})                       |
+--------------------------------------------------------------------------+
...
| Output                                                                                                   >>
+---------------------------------------------------------------------------------------------------------->>
| [Escaped Output] content_tag(:h3, "Red: #{@game.red.name} Vs. White: #{@game.white.name}", :id => "player>>
...
| [Escaped Output] render(partial => "shared/stats", {})                                                   >>
| [Escaped Output] will_paginate                                                                           >>
| [Escaped Output] render(action => (Game.paginate(:page => (params[:page]), :per_page => 15).where("winner>>
| [Escaped Output] will_paginate                                                                           >>
+---------------------------------------------------------------------------------------------------------->>
...
| [Escaped Output] form_for(:session, :url => (sessions_path)) do; [Escaped Output] (local f).label(:name, >>
...
| [Escaped Output] form_for(:session, :url => (sessions_path)) do; [Escaped Output] FormBuilder.new.label(:>>
| [Escaped Output] link_to("Sign up now!", signup_path)                                                    >>
+---------------------------------------------------------------------------------------------------------->>
...
shared/_stats.["StaticPagesController#home", "Template:static_pages/home"]
...
| [Escaped Output] (render(action => @waiting_ongoing_games, {}) or "You do not have any active games at th>>
...
| [Escaped Output] link_to(image_tag("Norman_Bethune_checkers_1937.jpg", :alt => "Checkers", :class => "img>>
+---------------------------------------------------------------------------------------------------------->>
...
| [Escaped Output] render(partial => "shared/stats", {})                                                   >>
| [Escaped Output] link_to("New game", new_game_path, :class => "btn btn-medium btn-primary")              >>
| [Escaped Output] unless current_user.waiting_and_ongoing_games.empty? then; "(#{current_user.waiting_and_>>
| [Escaped Output] (render(action => current_user.waiting_and_ongoing_games, {}) or "You do not have any ac>>
| [Escaped Output] unless Game.find(:all, :conditions => ({ :active => (false), :winner_id => (nil) })).emp>>
| [Escaped Output] (render(action => Game.find(:all, :conditions => ({ :active => (false), :winner_id => (n>>
| [Escaped Output] link_to("Sign up now!", signup_path, :class => "btn btn-large btn-primary")             >>
| [Escaped Output] link_to(image_tag("Norman_Bethune_checkers_1937.jpg", :alt => "Checkers", :class => "img>>
+---------------------------------------------------------------------------------------------------------->>
...
| [Escaped Output] form_for(@user) do; [Escaped Output] render(partial => "shared/error_messages", {});[Esc>>
+---------------------------------------------------------------------------------------------------------->>
...
| [Escaped Output] render(partial => "shared/stats", {})                                                   >>
| [Escaped Output] will_paginate                                                                           >>
| [Escaped Output] render(action => User.paginate(:page => (params[:page]), :per_page => 15).where(:admin =>>
| [Escaped Output] will_paginate                                                                           >>
+---------------------------------------------------------------------------------------------------------->>
...
| [Escaped Output] form_for(User.new(user_params)) do; [Escaped Output] render(partial => "shared/error_mes>>
+---------------------------------------------------------------------------------------------------------->>
...
| [Escaped Output] FormBuilder.new.password_field(:password_confirmation)                                  >>
| [Escaped Output] FormBuilder.new.submit("Create my account", :class => "btn btn-large btn-primary")      >>
| [Escaped Output] form_for(User.new) do; [Escaped Output] render(partial => "shared/error_messages", {});[>>
+---------------------------------------------------------------------------------------------------------->>
...
| [Escaped Output] "Wins: #{@user.win_count} | Losses: #{@user.loss_count}"                                >>
| [Escaped Output] "(#{@waiting_ongoing_games.count})" unless @waiting_ongoing_games.empty?                >>
| [Escaped Output] (render(action => @waiting_ongoing_games, {}) or "There are no active games at the momen>>
| [Escaped Output] "(#{@games.count})" unless @games.empty?                                                >>
| [Escaped Output] (render(action => @games, {}) or "There are no completed games on record.")             >>
+---------------------------------------------------------------------------------------------------------->>
...
| [Escaped Output] unless User.find(params[:id]).waiting_and_ongoing_games.empty? then; "(#{User.find(param>>
| [Escaped Output] (render(action => User.find(params[:id]).waiting_and_ongoing_games, {}) or "There are no>>
| [Escaped Output] unless User.find(params[:id]).completed_games.empty? then; "(#{User.find(params[:id]).co>>
| [Escaped Output] (render(action => User.find(params[:id]).completed_games, {}) or "There are no completed>>
+---------------------------------------------------------------------------------------------------------->>
